    ...
    public class BaseService
    {
        ...
        static BaseService()
        {
            ...
            _mapperConfiguration = new MapperConfiguration(cfg =>
            {
                ...
                .ForMember(i => i.InviterName, opt => opt.MapFrom(u => u.Inviter.UserName))
                .ForMember(i => i.InvitingCode, opt => opt.MapFrom(u => u.InvitingCode))
                ...
                .ForMember(i=>i.AuthorName,opt=>opt.MapFrom(a=>a.Author.UserName))
